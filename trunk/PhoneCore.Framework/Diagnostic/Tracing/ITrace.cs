...
namespace PhoneCore.Framework.Diagnostic.Tracing
{
    ...
    public interface ITrace: IDisposable
    {
        ...
        /// <param name="message"></param>
        void Info(ITraceCategory category, string message);
        ...
        /// <param name="category"></param>
        /// <param name="message"></param>
        void Warn(ITraceCategory category, string message);
        ...
        /// <param name="message"></param>
        /// <param name="exception"></param>
        void Error(ITraceCategory category, string message, Exception exception);
        ...
        /// <param name="message"></param>
        /// <param name="exception"></param>
        void Fatal(ITraceCategory category, string message, Exception exception);
